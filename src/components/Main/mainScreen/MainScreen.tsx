...
function MainScreen() {
    ...
    return (
        <div className={pathname === '/login'|| pathname ===  "/by-ticket" || pathname === '/register' || pathname === '/reset-password' || pathname.includes("hall")  || pathname.includes('detailed') ? 'hidden' : 'main'}>
